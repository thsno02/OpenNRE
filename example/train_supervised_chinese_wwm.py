...
parser.add_argument('--pretrain_path', default='chinese_wwm', 
...
# add dataset
parser.add_argument('--dataset', default='none', choices=['none', 'semeval', 'wiki80', 'tacred', 'people-relation'], 
...
# Some basic settings
root_path = os.path.join(os.getcwd(), 'opennre')
# add root_path into sys.path if it not in
if root_path not in sys.path:
        sys.path.append(root_path)
# create ckpt folder in the current working direction
...
# ckpt file path
model_name = args.pretrain_path.split(os.sep)[-1]
ckpt = os.path.join(ckpt, f'{args.dataset}_{model_name}_{args.pooler}.pth.tar')
